...
public class VentanaPrincipal extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 962, Short.MAX_VALUE)
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        if (!listaProductos.contains(especial)) {
            listaProductos.add(especial);
        }

        cantidadEspecial++;
        especial.setCantidad(cantidadEspecial);
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        ...
        if (listaProductos.contains(especial) && cantidadEspecial > 1) {
            cantidadEspecial--;
            especial.setCantidad(cantidadEspecial);
            ...
            cantEspecial.setText("0");
            if (listaProductos.contains(especial)) {
                listaProductos.remove(especial);
            }
            cargarDatosTabla(tablaOrden, listaProductos);
            actualizarTotal(listaProductos);
        }
